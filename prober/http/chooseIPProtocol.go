...
import (
	"context"
	"fmt"
	c "github.com/yuanyp8/http_exporter/conf"
	"go.uber.org/zap"
	"hash/fnv"
	"net"
	"time"
...
// 确定给定的target域名/ip对应的ip protocol
func (h *conf.HTTPProbe) chooseProtocol(ctx context.Context, target string) (ip *net.IPAddr, lookupTime float64, err error) {
